...
<!--imagen portada -->
        <div class="container-portada">
            <p>CONTACTO</p>
            <img src="../img/cotizador-imagen.jpg" class="d-block w-100" height="500"  alt="...">
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="card" style="width: 19rem;">
                  <img src="../img/nombre1.gif" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Miguel Rodriguez</h5>
                    <p class="card-text"></p>
                    <a href="https://www.facebook.com/mikerodmontepeque" class="text-reset p-1"><i class="fa-brands fa-facebook"></i></a>
                    <a href="https://www.instagram.com/miguestuard0/?hl=es" class="text-reset p-1"><i class="fa-brands fa-instagram"></i></a>
                    <a href="#" class="text-reset p-1"><i class="fa-brands fa-square-twitter"></i></a>
                    <a href="#" class="text-reset p-1"><i class="fa-brands fa-discord"></i></a>
                  </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card" style="width: 19rem;">
                  <img src="../img/nombre2.gif" class="card-img-top" height="290" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Erick Mejia</h5>
                    <p class="card-text"></p></p>
                    <a href="https://www.facebook.com/Erickm32" class="text-reset p-1"><i class="fa-brands fa-facebook"></i></a>
                    <a href="https://www.instagram.com/__erick.13__/?hl=es" class="text-reset p-1"><i class="fa-brands fa-instagram"></i></a>
                    <a href="https://twitter.com/ErickMejia_32" class="text-reset p-1"><i class="fa-brands fa-square-twitter"></i></a>
                    <a href="https://discord.gg/REukAtex" class="text-reset p-1"><i class="fa-brands fa-discord"></i></a>
                  </div>
                </div>
            </div>
